...
class MixFusion(nn.Module):
    def __init__(self, input_channels=256):
        ...
        self.residual = nn.Conv2d(input_channels*2, out_channels, kernel_size=1, bias=False)
        self.channel_embed = nn.Sequential(
                        nn.Conv2d(input_channels*2, out_channels, kernel_size=1, bias=True),
                        nn.Conv2d(out_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=True, groups=out_channels),
