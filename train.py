...
from datasets.DSECEIdataloader import make_data_loader
...
class Trainer:
    def __init__(self, args):
        ...
        #Loader
        self.train_loader = make_data_loader(args.batch_size, args.num_workers)
    ...
    def train(self):
        ...
        while keep_training:
            ...
            for index, (voxel1, voxel2, img1, img2, flow_map, valid2D) in bar:
                self.optimizer.zero_grad()
                flow_preds = self.model(voxel1.cuda(), voxel2.cuda(), img1.cuda(), img2.cuda())
                ...
                if (total_steps >= self.args.num_steps - 10000 and total_steps % 5000 == 0) or (total_steps < self.args.num_steps - 10000 and total_steps % 20000 == 0):
...
if __name__=='__main__':
    ...
    parser = argparse.ArgumentParser(description='STFlow')
    #training setting
